...
public struct AppleEventLogoDemoView: View {
    ...
    private var shaderLibrary = (try? ShaderLibrary(
        bundle: .metalSprocketsExampleShaders()).namespaced("AppleEventLogoShaders")
            ...
            .task {
                do {
                    ...
                    guard let maskURL = Bundle.module.url(forResource: "AppleLogoMask", withExtension: "png") else {
                        throw MetalSprocketsError.resourceCreationFailure("Could not find AppleLogoMask.png in bundle")
                    }
                    ...
                    guard let videoURL = Bundle.module.url(forResource: "AppleEventVideo", withExtension: "mp4") else {
                        throw MetalSprocketsError.resourceCreationFailure("Could not find AppleEventVideo.mp4 in bundle")
                    }
