...
public struct EdgeLinesDemoView: View {
    private static func createMesh(type meshType: MeshType) -> MeshWithEdges {
        ...
        case .teapot:
            ...
            guard let positionAttr = mdlVertexDescriptor.attributes[0] as? MDLVertexAttribute, let normalAttr = mdlVertexDescriptor.attributes[1] as? MDLVertexAttribute, let texCoordAttr = mdlVertexDescriptor.attributes[2] as? MDLVertexAttribute else {
