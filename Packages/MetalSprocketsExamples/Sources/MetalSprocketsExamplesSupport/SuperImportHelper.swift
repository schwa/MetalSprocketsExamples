...
class SuperImportHelper {
    ...
    private func ensureCachesDirectory() throws -> URL {
        let cachesDirectory = try FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first.orThrow(MetalSprocketsError.generic("Could not resolve caches directory"))
